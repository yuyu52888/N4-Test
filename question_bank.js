...
},
{
    ...
    options: [
        {text: "に", explanation: "正確答案：句意：這個工作請交給我（「に」表示動作的對象）。\n中文翻譯：這個工作請交給我。"},
...
},
{
    ...
    options: [
        {text: "で", explanation: "正確答案：句意：在車站和朋友會合（「で」表示動作發生的場所）。\n中文翻譯：在車站和朋友會合。"},
        {text: "に", explanation: "錯誤：「に」表示存在的場所，動作場所要用「で」。\n中文翻譯：在車站和朋友會合（助詞使用錯誤）。"},
        {text: "を", explanation: "錯誤：「を」表示賓語，與場所無關。\n中文翻譯：在車站和朋友會合（助詞使用錯誤）。"},
        {text: "から", explanation: "錯誤：「から」表示起點，與句意不符。\n中文翻譯：從車站和朋友會合（語意矛盾）。"}
    ],
    correctAnswer: 0
...
},
{
    ...
    options: [
        {text: "に", explanation: "正確答案：句意：這本書對孩子來說容易理解（「に」表示對象）。\n中文翻譯：這本書對孩子來說容易理解。"},
        {text: "が", explanation: "錯誤：「が」表示主語，與句意不符。\n中文翻譯：這本書對孩子來說容易理解（助詞使用錯誤）。"},
        {text: "を", explanation: "錯誤：「を」表示賓語，與句意不符。\n中文翻譯：這本書對孩子來說容易理解（助詞使用錯誤）。"},
        {text: "で", explanation: "錯誤：「で」表示場所或手段，與句意不符。\n中文翻譯：這本書對孩子來說容易理解（助詞使用錯誤）。"}
    ],
    correctAnswer: 0
...
},
{
    ...
    options: [
        {text: "に", explanation: "正確答案：句意：這個問題連孩子都懂（「に」表示對象）。\n中文翻譯：這個問題連孩子都懂。"},
        {text: "が", explanation: "錯誤：「が」表示主語，與「でも」搭配不自然。\n中文翻譯：這個問題連孩子都懂（助詞使用錯誤）。"},
        {text: "を", explanation: "錯誤：「を」表示賓語，與句意不符。\n中文翻譯：這個問題連孩子都懂（助詞使用錯誤）。"},
        {text: "で", explanation: "錯誤：「で」表示場所或手段，與句意不符。\n中文翻譯：這個問題連孩子都懂（助詞使用錯誤）。"}
    ],
    correctAnswer: 0
},
{
    ...
    options: [
        {text: "が", explanation: "正確答案：句意：電車晚點，沒趕上約定（「が」表示主語）。\n中文翻譯：電車晚點，沒趕上約定。"},
        {text: "に", explanation: "錯誤：「に」表示對象或時間，不用於主語。\n中文翻譯：電車晚點，沒趕上約定（助詞使用錯誤）。"},
        {text: "を", explanation: "錯誤：「を」表示賓語，與句意不符。\n中文翻譯：電車晚點，沒趕上約定（助詞使用錯誤）。"},
...
},
{
    ...
    options: [
        {text: "が", explanation: "正確答案：句意：這個工作需要經驗（「が」表示需要的對象）。\n中文翻譯：這個工作需要經驗。"},
        {text: "に", explanation: "錯誤：「に」表示目的或對象，但「必要」用「が」。\n中文翻譯：這個工作需要經驗（助詞使用錯誤）。"},
        {text: "を", explanation: "錯誤：「を」表示賓語，與句意不符。\n中文翻譯：這個工作需要經驗（助詞使用錯誤）。"},
        {text: "で", explanation: "錯誤：「で」表示手段，與句意不符。\n中文翻譯：這個工作需要經驗（助詞使用錯誤）。"}
    ],
    correctAnswer: 0
},
{
...
},
{
    ...
    options: [
        {text: "が", explanation: "正確答案：句意：這個蛋糕是妹妹做的（「が」表示動作主體）。\n中文翻譯：這個蛋糕是妹妹做的。"},
...
},
{
    ...
    options: [
        {text: "を", explanation: "正確答案：句意：我邊聽音樂邊學習（「を」表示賓語）。\n中文翻譯：我邊聽音樂邊學習。"},
        {text: "に", explanation: "錯誤：「に」表示對象，但「聞く」要用「を」。\n中文翻譯：我邊聽音樂邊學習（助詞使用錯誤）。"},
        {text: "が", explanation: "錯誤：「が」表示主語，與句意不符。\n中文翻譯：我邊聽音樂邊學習（助詞使用錯誤）。"},
        {text: "で", explanation: "錯誤：「で」表示手段，與句意不符。\n中文翻譯：我邊聽音樂邊學習（助詞使用錯誤）。"}
    ],
    correctAnswer: 0
},
{
    ...
    options: [
        {text: "を", explanation: "正確答案：句意：這班公車經過站前（「を」表示移動的經過點）。\n中文翻譯：這班公車經過站前。"},
