...
},
{
    ...
    options: [
        {
            text: "あかくて",
            explanation: "正確答案：形容詞て形用於連接兩個描述\n文法考點：い形容詞て形（～くて）的連接用法\n中文翻譯：這個蘋果又紅又好吃。"
        },
        {
            text: "あかい", 
            explanation: "錯誤：形容詞終止形不能直接連接句子\n中文翻譯：這個蘋果紅好吃（文法錯誤）。"
        },
        {
            text: "あかく",
            explanation: "錯誤：形容詞く形不能用於句子連接\n中文翻譯：這個蘋果紅好吃（文法錯誤）。"
        },
        {
            text: "あかかった",
            explanation: "錯誤：過去形與現在描述不符\n中文翻譯：這個蘋果曾經紅好吃（時態錯誤）。"
        }
    ],
    correctAnswer: 0
},
...
},
{
    ...
    options: [
        {
            text: "あったら",
            explanation: "正確答案：表示假設條件的邀請\n文法考點：條件形『～たら』的邀請用法，語氣自然\n中文翻譯：如果有時間的話，要不要去看電影？"
        },
        {
            text: "あると",
            explanation: "錯誤：『と』表示必然結果，不適合用於邀請\n中文翻譯：一有時間的話，要不要去看電影？（語氣不當）"
        },
        {
            text: "あり",
            explanation: "錯誤：動詞ます形不能單獨用於條件表達\n中文翻譯：如果有時間的話，要不要去看電影？（文法錯誤）"
        },
        {
            text: "あって",
            explanation: "錯誤：て形不能直接表示條件\n中文翻譯：如果有時間的話，要不要去看電影？（文法錯誤）"
        }
    ],
    correctAnswer: 0
},
...
},
{
    ...
    "type": "grammar",
    "question": "（ ）に なにを いれますか。",
    "sentence": "この 仕事、一人で（ ）そうですか？",
    "options": [
        {
            "text": "でき",
            "explanation": "正確答案：表示外觀判斷或推測\n文法考點：動詞ます形去ます＋そうだ，表示樣態或推測\n中文翻譯：這個工作，一個人好像能做到嗎？"
        },
        {
            "text": "する",
            "explanation": "錯誤：動詞原形不能接『そうだ』\n中文翻譯：這個工作，一個人好像做嗎？（文法錯誤）"
        },
        {
            "text": "して",
            "explanation": "錯誤：て形不能接『そうだ』\n中文翻譯：這個工作，一個人好像做嗎？（文法錯誤）"
        },
        {
            "text": "した",
            "explanation": "錯誤：過去形不能接『そうだ』\n中文翻譯：這個工作，一個人好像做了嗎？（文法錯誤）"
        }
    ],
    "correctAnswer": 0
},
...
},
{
    ...
    type: "grammar", 
    question: "（ ）に なにを いれますか。",
    sentence: "この 薬を 飲んだ（ ）、すぐに ねむく なりました。",
    options: [
        {
            text: "ら",
            explanation: "正確答案：表示條件達成後的發現\n文法考點：條件形『～たら』的發現用法，強調前項完成後的結果\n中文翻譯：吃了這個藥後，馬上就變得很想睡。"
        },
        {
            text: "と",
            explanation: "錯誤：『と』表示必然結果，不適合用於個人體驗\n中文翻譯：一吃這個藥，馬上就變得很想睡（語氣過於必然）。"
        },
        {
            text: "ば",
            explanation: "錯誤：『ば』表示假定條件，與過去事實不符\n中文翻譯：如果吃這個藥，馬上就變得很想睡（與事實矛盾）。"
        },
        {
            text: "なら",
            explanation: "錯誤：『なら』表示話題提示，與發現事實不符\n中文翻譯：要是吃這個藥的話，馬上就變得很想睡（語意不當）。"
        }
    ],
    correctAnswer: 0
},
...
},
{
    ...
    "type": "grammar",
    "question": "（ ）に なにを いれますか。",
    "sentence": "すみません、ここに 車を（ ）は いけませんか。",
    "options": [
        {
            "text": "止めても",
            "explanation": "正確答案：表示請求許可的委婉說法\n文法考點：動詞て形＋もいいですか，表示請求允許做某事\n中文翻譯：不好意思，這裡可以停車嗎？"
        },
        {
            "text": "止める",
            "explanation": "錯誤：動詞原形不能表示請求許可\n中文翻譯：不好意思，這裡停車不可以嗎？（文法錯誤）"
        },
        {
            "text": "止めた",
            "explanation": "錯誤：過去形不能用於請求許可\n中文翻譯：不好意思，這裡停了車不可以嗎？（時態錯誤）"
        },
        {
            "text": "止めます",
            "explanation": "錯誤：ます形不能表示請求許可\n中文翻譯：不好意思，這裡停車不可以嗎？（文法錯誤）"
        }
    ],
    "correctAnswer": 0
},
...
},
{
    ...
    "type": "grammar",
    "question": "（ ）に なにを いれますか。",
    "sentence": "あの レストランは 予約が（ ）、なかなか 入れません。",
    "options": [
        {
            "text": "いらないと",
            "explanation": "正確答案：表示條件關係的必然結果\n文法考點：條件形『～と』，表示前項條件成立時必然會發生的後項結果\n中文翻譯：那家餐廳如果不預約，就很難進去。"
        },
        {
            "text": "いらないなら",
            "explanation": "錯誤：『なら』表示話題提示，不適合用於必然結果\n中文翻譯：那家餐廳如果不需要預約的話，就很難進去（語意矛盾）。"
        },
        {
            "text": "いらなかったら",
            "explanation": "錯誤：過去形條件與現在事實不符\n中文翻譯：那家餐廳如果之前不需要預約，就很難進去（時態錯誤）。"
        },
        {
            "text": "いらなくて",
            "explanation": "錯誤：て形不能表示條件關係\n中文翻譯：那家餐廳不需要預約，就很難進去（文法錯誤）。"
        }
    ],
    "correctAnswer": 0
},
